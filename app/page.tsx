    ...
    <>
      <div className=" opacity-90 flex flex-col w-full">
        <div className="my-3 bg-[#f9e4b7] border-[#caa75c] border p-2 sm:rounded-lg w-full sm:w-6/7">
          <div className="flex flex-col justify-between gap-6 p-4 text-[#64480a]">
            ...
            <Flex gap="1">
              <Text as="p" size="5">
                ...
                down through generations. From the comforting warmth of classic Pad Thai
                to the aromatic allure of Green Curry, every dish is a celebration of
                Thailand’s diverse and dynamic culture. Join us in the heart of Deal, Kent
                for a dining experience that’s as welcoming as it is delicious. Let us
                take your taste buds on a journey through the Land of Smiles!
              </Text>
            </Flex>
